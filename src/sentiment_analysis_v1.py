...
# 设置路径
input_file_path = os.path.join('data', 'processed_data', 'topic_extracted_comments.csv')
output_file_path = os.path.join('data', 'processed_data','sentiment_analysis_results.csv')
...
# 进一步细致的情感分析可视化
plt.figure(figsize=(12, 8))
sns.boxplot(data=df, x='dominant_topic', y='sentiment_score', hue='dominant_topic', palette="Set2", legend=False)
